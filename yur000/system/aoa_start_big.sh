...
on -p 60r -d mm-aoa --maker LAVAH --model CHB027 --year 2019 --humaker FORYOU --humodel RN6RE3 --huswbuild 20181113 --huswversion V1.01.02-20181113 --vwidth 1280 --vheight 720 --maxfps 30 --wwidth 1280 --wheight 720 --pixelAspectRatio 10000,10667,10000 --density 160,140,160 --logfile /dev/shmem/aoa.log
